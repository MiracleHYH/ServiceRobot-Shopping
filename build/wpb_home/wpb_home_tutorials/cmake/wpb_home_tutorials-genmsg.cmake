...
get_filename_component(_filename "/home/zzy/catkin_ws/src/wpb_home/wpb_home_tutorials/srv/Follow.srv" NAME_WE)
add_custom_target(_wpb_home_tutorials_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "wpb_home_tutorials" "/home/zzy/catkin_ws/src/wpb_home/wpb_home_tutorials/srv/Follow.srv" ""
)
...
_generate_srv_cpp(wpb_home_tutorials
  "/home/zzy/catkin_ws/src/wpb_home/wpb_home_tutorials/srv/Follow.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/wpb_home_tutorials)
  install(CODE "execute_process(COMMAND \"/home/zzy/anaconda3/envs/ros/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/wpb_home_tutorials\")")
  # install generated code
  install(
