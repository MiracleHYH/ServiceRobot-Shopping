...
get_filename_component(_filename "/home/zzy/catkin_ws/src/xfyun_waterplus/srv/IATSwitch.srv" NAME_WE)
add_custom_target(_xfyun_waterplus_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "xfyun_waterplus" "/home/zzy/catkin_ws/src/xfyun_waterplus/srv/IATSwitch.srv" ""
)
...
_generate_srv_cpp(xfyun_waterplus
  "/home/zzy/catkin_ws/src/xfyun_waterplus/srv/IATSwitch.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/xfyun_waterplus)
  install(CODE "execute_process(COMMAND \"/home/zzy/anaconda3/envs/ros/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/xfyun_waterplus\")")
  # install generated code
  install(
