...
def audio_record(rec_time,ws):
    ...
    for i in range(0, int(RATE / CHUNK * rec_time)):
        ...
        logger.debug(f'the{i}times record')
...
pub=rospy.Publisher('listen_result',String,queue_size=10)
rospy.init_node('listen_recognize',anonymous=True)
rospy.loginfo(msg=f'''{Fore.GREEN}the results is publish to the topic 'listen_result'
the listenning begin ,the callback type is 'String'
''')
def on_message(ws, message):
    ...
    pub.publish(str(data.get('result',"")))
